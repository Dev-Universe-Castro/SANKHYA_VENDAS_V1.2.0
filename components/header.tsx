...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <>
      <header className="border-b border-sidebar-border px-4 lg:px-6 py-4 flex items-center justify-between bg-[#24292E] relative h-20">
        {/* Logo móvel - centralizado */}
        <div className="lg:hidden absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
          <img
        ...
        {/* Espaçador à esquerda no mobile para balancear o layout */}
