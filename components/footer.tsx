...
import { Home, Route, ShoppingCart, LayoutGrid, Menu } from "lucide-react"
...
export default function Footer() {
  ...
  return (
    <>
      <footer className="border-t border-white/10 lg:relative fixed bottom-0 left-0 right-0 z-40 bg-[#24292E]">
        {/* Mobile Navigation */}
