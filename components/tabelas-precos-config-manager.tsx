                      ...
                      <div className="flex gap-2 justify-end" onClick={(e) => e.stopPropagation()}>
                        <Button
                          ...
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                            console.log('✏️ Botão editar clicado para config:', config.CODCONFIG)
                            abrirModalEditar(config)
                          }}
                          disabled={loading}
                          type="button"
                        >
                        ...
                        <Button
                          ...
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                            console.log('🗑️ Botão deletar clicado para config:', config.CODCONFIG)
