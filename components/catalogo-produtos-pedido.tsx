...
export function CatalogoProdutosPedido({
  ...
  const handleSelecionarProdutoConfig = async (produto: any) => {
    ...
    try {
      ...
      const nutabNumber = Number(tabelaPreco)
      ...
      if (precos.length > 0 && precos[0].VLRVENDA) {
        precoFinal = parseFloat(String(precos[0].VLRVENDA).replace(/,/g, '.'))
      }
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-gray-400 uppercase font-bold tracking-tighter">Preço Unit.</span>
